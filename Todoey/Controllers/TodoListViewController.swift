...
class TodoListViewController: SwipeTableViewController {
    ...
    func updateNavBar(withHexCode colorHexCode: String) {
        ...
        navBar.largeTitleTextAttributes = [NSAttributedString.Key.foregroundColor: ContrastColorOf(navBarColor,
                                                                                                    returnFlat: true)]
        navBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: ContrastColorOf(navBarColor,
                                                                                               returnFlat: true)]
        searchBar.barTintColor = navBarColor
        searchBar.tintColor = ContrastColorOf(navBarColor, returnFlat: true)
        searchBar.backgroundColor = ContrastColorOf(navBarColor, returnFlat: true)
    }
